...
{
    public class oldFxSplitPanelsDesigner : ParentControlDesigner
    {
        public override void Initialize(IComponent component)
        {
            base.Initialize(component);

            var Panel1 = ((Controls.oldFxSplitPanels)this.Control).Panel1;
            var Panel2 = ((Controls.oldFxSplitPanels)this.Control).Panel2;
    ...
    public class oldPanelDesigner : ParentControlDesigner
    {
